export type GetDataHandleFn = (err: null | { message: string, stack?: string }, data?: unknown) => void
...
export type ResponseMessage =
  | [CALL_TYPES.RESPONSE | CALL_TYPES.CALLBACK_RESPONSE, string, { message: string, stack?: string }]
